...
import { teamMembers, siteStats } from '../data/content';
            ...
            <div className="p-6 md:p-10 space-y-16 lg:space-y-20">
                ...
                <section className="bg-indigo-600 text-white rounded-lg p-8">
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
                        <div>
                            <p className="text-4xl font-extrabold">{siteStats.learners}</p>
                            <p className="text-indigo-200 font-medium mt-1">Học viên</p>
                        </div>
                        <div>
                            <p className="text-4xl font-extrabold">{siteStats.courses}</p>
                            <p className="text-indigo-200 font-medium mt-1">Khóa học chất lượng</p>
                        </div>
                        <div>
                            <p className="text-4xl font-extrabold">{siteStats.satisfactionRate}</p>
