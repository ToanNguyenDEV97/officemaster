...
import { FaBookOpen, FaRegClock, FaUsers, FaBullseye, FaPlay, FaInfinity, FaCertificate, FaChevronRight } from 'react-icons/fa';
        ...
        <div className="bg-white rounded-xl border border-slate-200">
            ...
            <div className="p-6 md:p-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <aside className="lg:col-span-1 space-y-8">
                    ...
                    <InfoCard title="Lộ trình này dành cho ai?" icon={<FaUsers className="text-indigo-500"/>}>
