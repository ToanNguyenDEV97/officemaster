        ...
        <div className="bg-white rounded-xl border border-slate-200 p-6 md:p-8">
            <div className="max-w-4xl mx-auto">
                <header className="text-center mb-10">
                    <h1 className="text-3xl md:text-4xl font-bold text-slate-800">Điều khoản Dịch vụ</h1>
                    <p className="mt-2 text-slate-500">Cập nhật lần cuối: 25 tháng 07, 2024</p>
                </header>

                <div className="prose prose-slate max-w-none prose-h2:font-bold prose-h2:text-2xl prose-h2:text-slate-800 prose-h2:mb-4 prose-p:leading-relaxed prose-a:text-indigo-600 hover:prose-a:text-indigo-800">
