...
import { FaHome, FaRoad, FaQuestionCircle, FaBuilding, FaLaptopCode, FaComments } from 'react-icons/fa';
...
const Sidebar: React.FC<SidebarProps> = ({ currentPage, onNavigate }) => {
    ...
    return (
        <aside className="hidden lg:flex fixed top-16 left-0 h-[calc(100%-4rem)] bg-white dark:bg-slate-900 w-20 flex-col items-center z-40 border-r border-slate-200 dark:border-slate-800 py-2">
