...
const HeroSection: React.FC<HeroSectionProps> = ({ slides = defaultSlides }) => {
  ...
  if (slides.length === 0) {
    return (
        <div className="relative w-full rounded-2xl overflow-hidden bg-slate-200 dark:bg-slate-800 pt-[40%] sm:pt-[35%] md:pt-[30%] lg:pt-[26%] xl:pt-[22%]">
            <div className="absolute inset-0 flex items-center justify-center">
                <p className="text-slate-500 dark:text-slate-400">Loading slides...</p>
            </div>
        </div>
    )
  }
